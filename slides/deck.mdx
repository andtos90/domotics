...
<div style={{width: "80vw"}}>
  <p>Home automation or domotics is building automation for a home, called a smart home or smart house.</p>
</div>
...
<div style={{width: "80vw"}}>
  <p>La domotica, dall'unione del termine domus, e che in latino significa "casa", e del suffisso greco ticos, che indica le discipline di applicazione, è la scienza interdisciplinare che si occupa dello studio delle tecnologie adatte a migliorare la qualità della vita nella casa e più in generale negli ambienti antropizzati.</p>
</div>
